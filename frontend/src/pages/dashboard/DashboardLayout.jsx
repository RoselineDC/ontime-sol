...
import profile from '../../assets/profile/profilr.png';
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">ROSELINE DANGAZELA</span>
              <span className="text-sm text-gray-600">SOFTWARE DEVELOPER</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src={profile} alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
      ...
      <main className="p-6 sm:p-10 space-y-6 ">
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            ...
            <h2 className="text-gray-600 ml-0.5">Ontime Solution Inventory</h2>
          </div>
